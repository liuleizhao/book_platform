    	...
    	<div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" action="${ctx }/backend/system/user/<c:choose><c:when test="${user == null }">add</c:when><c:otherwise>edit</c:otherwise></c:choose>" method="post" name="form" id="form">
                            <c:if test="${user != null }">
