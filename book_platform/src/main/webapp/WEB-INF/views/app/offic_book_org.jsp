...
<head>
	...
	<body>
		...
		<s:token></s:token>
			...
			<div class="i-btn-box">
				<button type="button" class="mui-btn i-btn-bule" onclick="window.location.href = '${ctx }/app/book/book_ok'">预约</button>
			</div>	
		</form>
		</div>
		</div>
	</body>
	<script data-main="${ctx }/static/app/js/main" id="currentPage" target-module="offic_book_org" src="${ctx }/static/app/js/require.min.js"></script>
</html>