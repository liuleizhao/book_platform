...
<head>
	...
	<body> 
		<div class="mui-content">
			<div class="i-content-padded">
				<c:choose>
					<c:when test="${carInfo == null}"><form action="${ctx }/app/carInfo/add" method="post" id="form"></c:when>
	...
	<script data-main="${ctx }/static/app/js/main" id="currentPage" target-module="book_info_detail" src="${ctx }/static/app/js/require.min.js"></script>
</html>
