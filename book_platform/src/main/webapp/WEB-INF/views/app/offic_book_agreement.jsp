	...
	<body>
		<div class="mui-content">
			<div class="i-content-padded">
		      ...
		      <div class="i-btn-box">
				<button type="button" class="mui-btn i-btn-bule" onclick="window.location.href = '${ctx }/app/book/login'">接受（下一步）</button>
			</div>
			</div>
		</div>
	</body>
	<script data-main="${ctx }/static/app/js/main" id="currentPage" target-module="offic_book_agreement" src="${ctx }/static/app/js/require.min.js"></script>
</html>
