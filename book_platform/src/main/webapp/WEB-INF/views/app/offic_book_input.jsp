		...
		<div class="mui-content">
			<div class="i-content-padded">
				<form action="" method="post">
					...
					<div class="i-btn-box">
						<button type="button" class="mui-btn i-btn-bule" onclick="window.location.href = '${ctx }/app/book/org'">下一步</button>
					</div>
				</form>
			</div>
		</div>
	</body>
	<script data-main="${ctx }/static/app/js/main" id="currentPage" target-module="offic_book_input" src="${ctx }/static/app/js/require.min.js"></script>
</html>