...
<head>
					...
					<c:forEach items="${carInfoList }" var="item" >
						<li class="mui-table-view-cell i-li">
							...
							<div car_id="${item.id }" class="i-li-content">
			                    <span class="mui-h6">创建时间：<fmt:formatDate value="${item.createDate }" pattern="yyyy-MM-dd" /></span>
	...
	<script data-main="${ctx }/static/app/js/main" id="currentPage" target-module="car_info_list" src="${ctx }/static/app/js/require.min.js"></script>
</html>