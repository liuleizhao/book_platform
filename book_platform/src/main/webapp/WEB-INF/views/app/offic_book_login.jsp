...
<head>
		...
		<div class="mui-content">
			<div class="i-content-padded">
				<form action="" id="" method="">
					...
					<div class="i-btn-box">
						<button type="button" class="mui-btn i-btn-bule" onclick="window.location.href = '${ctx }/app/book/offic_book_input'">登录</button>
					</div>
				</form>
				<table>
		        <tr>
	...
	<script data-main="${ctx }/static/app/js/main" id="currentPage" target-module="offic_book_login" src="${ctx }/static/app/js/require.min.js"></script>
</html>